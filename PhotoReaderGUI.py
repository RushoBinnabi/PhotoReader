...
analyzeImageText = tkinter.Button(mainWindow, text="Analyze Image Text")
analyzeImageText.pack(side=tkinter.TOP, padx=10, pady=50)
analyzeImageText.place(x=120, y=78)

clearButton = tkinter.Button(mainWindow, text="Clear Image and Text")
clearButton.pack(side=tkinter.TOP, padx=10, pady=50)
clearButton.place(x=250, y=78)

leftArrowButton = tkinter.Button(mainWindow, image=leftArrowIconImage)
leftArrowButton.pack(side=tkinter.TOP, padx=10, pady=50)
leftArrowButton.place(x=185, y=120, width=40)

rightArrowButton = tkinter.Button(mainWindow, image=rightArrowIconImage)
